                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Actualização de Dados</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('estudantes.update',$estudante) }}" autocomplete="off">
                            @method('put')
                            @csrf

                            <h6 class="heading-small text-muted mb-4">Dados do estudante {{ $estudante->id }}</h6>
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('nome') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nome" id="input-name"
                                        ...
                                        placeholder="" value="{{$estudante->nome}}" required autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="celular" id="input-celular"
                                            ...
                                            placeholder="" value="{{$estudante->celular }}" required autofocus>
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="email" id="input-email"
                                            ...
                                            placeholder="" value="{{$estudante->email }}" required autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="endereco" id="input-endereco"
                                            ...
                                            placeholder="" value="{{ $estudante->endereco}}" required autofocus>
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="date" name="data_nascimento" id="input-data_nascimento"
                                            ...
                                            placeholder="" value="{{ $estudante->data_nascimento }}" required autofocus>
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="gerenero" id="input-gerenero"
                                            ...
                                            <option value="{{$estudante->genero}}" selected>{{ $estudante->genero }}</option>
