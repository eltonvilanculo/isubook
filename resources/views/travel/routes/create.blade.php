@extends('layouts.app', ['page' => 'Nova Trajetória', 'pageSlug' => 'categories', 'section' => 'inventory'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Nova Trajetória</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('routes.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Informações da Trajetória</h6>
                            <div class="pl-lg-4">
